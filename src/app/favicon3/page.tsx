...
export default function Favicon3Page() {
  useEffect(() => {
    ...
    link.href = `/digital400-d.ico?v=${timestamp}`; // Using digital400-d.ico for testing
    ...
    link2.rel = 'icon';
    link2.href = `/digital400-d.ico?v=${timestamp}`;
    document.head.appendChild(link2);
    
    // Update title
    document.title = 'Favicon Test 3 - Alternative (digital400-d.ico)';
  }, []);

  return (
    <div className="min-h-screen bg-green-50 flex items-center justify-center">
      <div className="max-w-md mx-auto text-center p-8">
        <div className="text-2xl font-bold text-green-600 mb-4">Favicon Test 3</div>
        <div className="text-gray-600 mb-8">Testing: <strong>digital400-d.ico</strong></div>
